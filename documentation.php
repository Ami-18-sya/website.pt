   ...
   <div class="container-fluid p-0">
      ...
      <div id="hero-section" class="w-100 d-flex justify-content-center align-items-center" style="height: 100vh;">
         ...
         <div class="position-relative w-25 d-flex justify-content-center align-items-center flex-column">
            <h2 class="border-bottom border-white text-center text-white fs-1 w-100 fw-semibold" style="text-shadow: 1px 1px 1px #1a1a1a;">DOCUMENTATION</h2>
            <a class="btn btn-primary" style="width: fit-content;" href="#documentation-section">MORE</a>
         </div>
      </div>
      <div id="documentation-section" class="container-fluid py-5">
         <div class="row">
            <div class="col-12 py-5">
               <h6 class="text-center fs-2 fw-semibold">Documentation of activities</h6>
