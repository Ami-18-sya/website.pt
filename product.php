   ...
   <div class="container-fluid p-0">
      ...
      <div id="hero-section" class="w-100 d-flex justify-content-center align-items-center" style="height: 100vh;">
         ...
         <div class="position-relative w-25 d-flex justify-content-center align-items-center flex-column">
            <h2 class="border-bottom border-white text-center text-white fs-1 w-100 fw-semibold" style="text-shadow: 1px 1px 1px #1a1a1a;">Product Us</h2>
            <a class="btn btn-primary" style="width: fit-content;" href="#product-section">MORE</a>
         </div>
      </div>
